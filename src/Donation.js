        ...
        <div className="bg-white bg-opacity-90 p-6 rounded-2xl shadow-xl text-center space-y-6">
            ...
            <div className="space-y-2">
                ...
                <select id="organ-donation" className="w-75 px-4 py-2 text-gray-700 bg-gray-100 border border-gray-300 rounded-md focus:ring-2 focus:ring-purple-400 focus:outline-none mx-auto">
                    <option value="" disabled defaultValue={'Select and option'}>Select an option</option>
            ...
            <div className="space-x-4">
                ...
                <button className="px-6 py-2 text-white bg-blue-600 rounded-md shadow hover:bg-blue-700 focus:ring-2 focus:ring-blue-400 focus:outline-none" onClick={() =>{navigate('/donorform')}}>
                    Donate
                </button>
                
                <button className="px-6 py-2 text-white bg-green-600 rounded-md shadow hover:bg-green-700 focus:ring-2 focus:ring-green-400 focus:outline-none" onClick={()=>{navigate('/requestform')}}>
                    Request
                </button>
            </div>
